...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadFeedActions_requestedFeedFromLoader() {
        ...
        sut.simulateUserInitiatedFeedReload()
        XCTAssertEqual(loader.loadFeedCallCount, 3, "Expected a third loading request once user ibniate another load")
    }
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertEqual(sut.isShowingLoadingIndicator, false, "Expected no loading indicatore once loading completes successfully")
    ...
    func test_loadFeedCompletion_renderSuccessfullyLoaderFeed() {
    ...
    func test_feedImageViewLoadingIndicator_isVisibleWhileLoadingImage() {
        ...
        XCTAssertEqual(view0?.isShowingImageLoadingIndicator, false, "Expected no loading indicator for first view once loading first image completes successfully")
    ...
    func test_feedImageView_rendersImageLoaderFromURL() {
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageViewRetryButton_isVisibleOnImageURLLoadError() {
        ...
        XCTAssertEqual(view1?.isShowingRetryAction, true, "Expected no retry action state change for second view once first image loading completes successfully")
    }
    ...
    func test_feedImageViewRetryAction_retriesImageLoad() {
        ...
        let view0 = sut.simulateFeedImageViewVisible(at: 0)
        let view1 = sut.simulateFeedImageViewVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.url, image1.url], "Expected two image URL request for the tow visible views")
    ...
    func test_feedImageView_preloadsImageURLWhenNearVisibile() {
        let image0 = makeImage(url: URL(string: "https://url-0.com")!)
        let image1 = makeImage(url: URL(string: "https://url-1.com")!)
        let (sut, loader) = makeSUT()
    ...
    func test_feedImageView_cancelsImageURLPrelodingWhenNotNearVisibileAnymore() {
        let image0 = makeImage(url: URL(string: "https://url-0.com")!)
        let image1 = makeImage(url: URL(string: "https://url-1.com")!)
        let (sut, loader) = makeSUT()
